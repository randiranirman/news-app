                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item pe-auto">
                                <div className="nav-link active pointer" aria-current="page" onClick={() => setCategory("technology")}>Technology</div>
                            </li>
                            <li className="nav-item">
                                <div className=" nav-link active hover-white" aria-current="page" onClick={() => setCategory("business")}>Business</div>
                            </li>
                            <li className="nav-item">
                                <div className="nav-link active pe-auto" aria-current="page" onClick={() => setCategory("health")}>Health</div>
                            </li>
                            <li className="nav-item">
